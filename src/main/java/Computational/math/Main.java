            ...
            do {
                ...
                try {
                    if (Integer.parseInt(data) <= 4 && Integer.parseInt(data) >= 1) {
                        ...
                        //todo а это точно нужно здесь? Оно не срабатывает:D
                        Functions function = new Functions(numberOfChosenFunction);
                        if(function.getDifValueFunction(a) * function.getDifValueFunction(b) >= 0){
