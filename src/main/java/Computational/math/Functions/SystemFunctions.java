...
//    public List<BinaryOperator<Double>> getChosenSystem(){
//        return firstSystem;
//    }
    ...
    public static void printAllSystem(){
        ...
        System.out.println("/");
        System.out.println("|\t2xy+3y^2-5=0");
        System.out.println("|");
